...
export function createHookProxy(
  ...
  return {
    ...
    get iflowConnectionStatus() { return hookRef.current.iflowConnectionStatus; },
    get isCheckingIFlow() { return hookRef.current.isCheckingIFlow; },
    get handleTestIFlowConnection() { return hookRef.current.handleTestIFlowConnection; },
    get handleDiscoverIFlowModels() { return hookRef.current.handleDiscoverIFlowModels; },
